...
<?php include './layout/header.php'; ?>
            ...
            <?php
                if (isset($_GET['succ'])) {
                    ...
                    if ($_POST['submit']) {
                        ...
                        // Subject
                        $subject = 'Contact details from Techzobris website';

                        // Message
                        $message = '
        <html>
        <head>
          <title>Contact details from Techzobris website</title>
        </head>
        <body>
        <h1>Contact details from Techzobris website</h1>
          <table>
            <tr>
        ...
        ';
                        ...
                        $headers[] = 'From: Vamana Website <hr@vamana.com>';
                    ...
                    ?>
                        <div class="clearfix position-relative text-center ">
                            <div class="alert col-xs-offset-1 col-xs-10 col-md-6 col-xs-offset-3 mt-3 alert-success mx-auto" role="alert">
            ...
            <section class="contact-block">
                <div class="container">
                    <div class="col-md-6 contact-left-block">
                        <h3><span>Contact </span>HOTEL VAMANA INN</h3>
                        ...
                        <p class="text-right"><a href="mailto:vamanainn@gmail.com"> vamanainn@gmail.com <i class="fa fa-envelope"></i></a></p>
                    </div>
               <div class="container">
                    <div class="col-md-6 contact-left-block">
                        <h3><span>Contact </span>ANA HOLIDAYS</h3>
                    ...
                    <div class="col-md-6 contact-form">
                        ...
                        <form action="<?php echo $base_url; ?>contact-us?succ=succ" method="POST" onsubmit="return validateForm()" method="post">
                            <input type="text" class="form-control" name="Name" placeholder="Name" required="">
                            <input type="text" class="form-control" name="Phoneno" placeholder="Phone Number"  id="Phoneno" required="">
            ...
            <section class="offspace-70">
                <div class="map">
                    <div class="container">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3877.1550541026245!2d79.422728874132!3d13.648330399682616!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a4d4a561e1a363b%3A0x5870650dbfe6111b!2sAlipiri%20Police%20Station!5e0!3m2!1sen!2sin!4v1740202364227!5m2!1sen!2sin" frameborder="0" style="border:0; width: 100%; height: 400px" allowfullscreen></iframe>
                    </div>
                </div>
            </section>
