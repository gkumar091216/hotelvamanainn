                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6 width-50">
                        <div class="service-details text-center">
                            ...
                            <h4><a>HIGH SPEED FREE INTERNET AVAILABLE</a></h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6 width-50">
                        <div class="service-details text-center">
                            ...
                            <h4><a>ROOM SERVICE AVAILABLE 24 X 7</a></h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6 mt-25">
                        <div class="service-details text-center">
                            ...
                            <h4><a>TRAVELS AND TOUR PACKAGES</a></h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6 mt-25">
                        <div class="service-details text-center">
                            ...
                            <h4><a>CHECK-IN 14:00 HRS CHECK-OUT 11:00 HRS</a></h4>
                        </div>
                    </div>
                </div>
            </div>
